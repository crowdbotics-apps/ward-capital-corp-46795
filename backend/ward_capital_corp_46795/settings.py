"""
Django settings for ward_capital_corp_46795 project.
...
ROOT_URLCONF = 'ward_capital_corp_46795.urls'
...
WSGI_APPLICATION = 'ward_capital_corp_46795.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ward_capital_corp_46795 API",
    "DESCRIPTION": "API documentation for ward_capital_corp_46795 App",
    "VERSION": "v1",
}
